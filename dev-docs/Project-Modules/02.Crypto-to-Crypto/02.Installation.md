...
This guide has everything you need to set up the Rahat C2C monorepo. The Rahat C2C project is used to streamline crypto cash transfers for humanitarian aid, as demonstrated during a [pilot program in Kenya](https://www.unicef.org/innovation/stories/how-blockchain-can-transform-humanitarian-cash-transfers-scale). This project includes advanced features such as:
